...
export class DepartamentOperations {
   ...
   */
  list(options?: Models.DepartamentListOptionalParams): Promise<Models.DepartamentListResponse>;
  /**
   * @param callback The callback
   */
  list(callback: msRest.ServiceCallback<Models.ListOKResponse>): void;
  /**
   * @param options The optional parameters
   * @param callback The callback
   */
  list(options: Models.DepartamentListOptionalParams, callback: msRest.ServiceCallback<Models.ListOKResponse>): void;
  list(options?: Models.DepartamentListOptionalParams | msRest.ServiceCallback<Models.ListOKResponse>, callback?: msRest.ServiceCallback<Models.ListOKResponse>): Promise<Models.DepartamentListResponse> {
